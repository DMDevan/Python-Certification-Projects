...
## Testing the code with an employee named 'Charlie Brown' starting as a trainee. 
# The code demonstrates the string representation of the employee, 
# the base salary, and a promotion to junior level.
